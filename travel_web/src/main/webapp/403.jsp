...
<head>
    ...
    <meta name="description" content="旅游后台管理系统">
    <meta name="keywords" content="旅游后台管理系统">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu"><a href="#"
                            ...
                            src="${pageContext.request.contextPath}/img/user9.png"
        ...
        <section class="content">
            <div class="error-page">
                ...
                <div class="error-content">
                    ...
                    <p>
                        权限不足 , 你可以 <a href="${pageContext.request.contextPath}/login.jsp">重新登录</a>
                    </p>
