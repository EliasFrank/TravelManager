						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								...
								<c:forEach items="${productList}" var="product">
									<option value="${product.id}" <c:if test="${product.id==1}">selected</c:if>>${product.productName}</option>
								</c:forEach>
							</select>
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								...
								<c:forEach items="${memberList}" var="member">
									<option value="${member.id}" <c:if test="${member.id==1}">selected</c:if>>${member.name}</option>
								</c:forEach>
							</select>
						</div>
